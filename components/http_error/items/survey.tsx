...
const map = {
  0: 'linear-gradient(315deg, rgb(224 30 30), rgb(149 125 125))',
      ...
      {data?.length ? (
        data?.map((item) => {
          return (
            <span
              key={item.status}
              className=" float-left flex justify-center items-center  w-[200px] h-[108px] bg-[#fafafa] rounded-sm mr-4 py-6 px-5 box-border"
            >
              <span
                style={{
                  background:
